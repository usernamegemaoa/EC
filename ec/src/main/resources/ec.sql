...
CREATE TABLE IF NOT EXISTS `kind` (
    ...
    `father_id` INT(11) COMMENT '父类id',
    `kind_name` VARCHAR(64) NOT NULL COMMENT '分类名',
    PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `picture` (
    ...
    `good_id` INT(11) NOT NULL COMMENT '商品id',
    `file` VARCHAR(255) NOT NULL COMMENT '图片路径',
    `main` VARCHAR(11) NOT NULL COMMENT '主图片',
    PRIMARY KEY (`id`),
    FOREIGN KEY (`good_id`) REFERENCES `good` (`id`)
...
CREATE TABLE IF NOT EXISTS `hot` (
	`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '同类热销id',
	`first_id` INT(11) NOT NULL COMMENT '第一件商品',
