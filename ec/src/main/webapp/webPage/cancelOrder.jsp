				...
				<s:iterator value="#each_order.goodList" var="each_good">
					<div class="panel-body">
						...
						<div class="right">
							...
							<s:if
								test="#each_order.status=='待支付' || #each_order.status=='待发货'">
								<span><a
									onclick="cancelOrder('<s:property value="#each_order.orderId"/>')">取消订单</a></span>
							</s:if>
						</div>
					</div>
				</s:iterator>
