		...
		<div class="row">
			<div class="col-sm-2 sidebar"
				...
				<ul class="nav nav-sidebar">
					...
					<s:if test="role==2">
						<li style="margin-left: 15px"><a href="AddGood" id="AddGood"
							name="orderCenter" target="i">添加商品</a></li>
					</s:if>
				</ul>
				<ul class="nav nav-sidebar">
			...
			<div class="col-sm-10">
				<iframe src="getUserInfo" id="iframe" name="i" class="main"
					style="height: 700px;width: 100%" frameborder="0" scrolling="yes">
				</iframe>
			</div>
		</div>
	</div>
