...
public class GoodServiceImpl implements GoodService {
	...
	getKindGood(final KindVo kind, final int page) {
		...
		int maxResult = perPage;
		List<Good> kindGoods = 
				goodDao.getKindGoods(kindId, firstResult, maxResult);
	...
	public final List<SimpleGoodVo> 
		...
		int firstResult = page * perPage;
		int maxResult = perPage;
		List<Good> searchGoods = 
				goodDao.getNameGoods(search, firstResult, maxResult);
	...
	getConsults(final int goodId, final int pages) {
		...
		List<Consult> consults = 
				consultDao.getConsults(goodId, firstResult, maxResult);
	...
	getComments(final int goodId, final int pages) {
		...
		List<Comment> comments = 
				commentDao.getComments(goodId, firstResult, maxResult);
